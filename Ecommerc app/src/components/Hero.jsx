...
//   return (
//     <div className="relative flex flex-col md:flex-row items-center justify-center h-[60vh] md:h-[50vh] lg:h-[40vh] xl:h-[30vh] overflow-hidden">
//       <div className="w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-8 lg:px-12 py-4 md:py-6 lg:py-8">
        
//         {/* Image Section */}
//         <div className="relative w-full md:w-2/3 lg:w-1/2 h-[60vh] md:h-[50vh] lg:h-[40vh] xl:h-[30vh] flex items-center">
//           <img
...
//         <div className="mt-6 md:mt-0 w-full md:w-auto text-center md:text-left md:pl-6 lg:pl-8">
//           <h2 className="text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold tracking-tight text-zinc-800">
//             {images[currentIndex].label}
//           </h2>
//           <div className="mt-3 flex items-center justify-center md:justify-start gap-2">
//             <p className="w-10 md:w-12 lg:w-16 h-[1px] bg-[#414141]"></p>
//             <p className="text-sm md:text-base lg:text-lg font-semibold uppercase">shop now</p>
//           </div>
//         </div>
//       </div>
//     </div>
